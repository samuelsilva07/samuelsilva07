...
## 💡 Minhas habilidades
<ul type="square">
  <li><strong>Desenvolvimento web:</strong> Possuo experiência com criação de sites utilizando <strong>HTML5</strong> e <strong>CSS3</strong>, com foco na criação de interfaces responsivas e funcionais.</li>
  <li><strong>Linguagem C:</strong> Tenho uma boa familiaridade com a linguagem <strong>C</strong>, que me auxiliou a entender conceitos fundamentais como algoritmos, lógica de programação e estrutura de dados.</li>
  <li><strong>Python</strong>: Atualmente estou aprofundando meus conhecimentos em <strong>Python</strong> com o objetivo de solucionar problemas complexos, utilizando linguagens de alto nível.</li>
</ul>
<br>
...
## ✉️ Converse comigo!
<a href="#">![Gmail](https://img.shields.io/badge/-Gmail-F05032?logo=gmail&logoColor=white&style=flat)</a>
